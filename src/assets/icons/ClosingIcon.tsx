...
export const ClosingIcon = ({ width = "16", height = "16", fill = "#313037"}) => {
  return (
      <svg
          width={width}
          height={height}
